  ...
  private async init() {
    ...
    this.initPromise = (async () => {
      try {
        ...
        // 修改条件判断，使其在Node.js环境中正确加载nodejieba
        const isNodeEnvironment = typeof window === "undefined" || typeof globalThis !== "undefined"
        ...
        jiebaResult.forEach((word: string) => {
          ...
          if (start !== -1) {
            const token: Token = {
              ...
              type: this.customDict.get(word) || this.determineTokenType(word),
            }
