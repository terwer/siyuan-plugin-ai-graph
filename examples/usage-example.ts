  ...
  const exampleDocs: Document[] = [
    {
      id: 'doc_1',
      title: '人工智能基础',
      content: '人工智能（Artificial Intelligence，简称AI）是计算机科学的一个分支，研究如何使计算机能够模拟人类的智能行为。机器学习是AI的重要组成部分，深度学习是机器学习的一个分支。',
      tags: ['AI', '机器学习'],
      createdAt: Date.now(),
      updatedAt: Date.now(),
    },
    {
      id: 'doc_2',
      title: '深度学习简介',
      content: '深度学习（Deep Learning）是机器学习的一种方法，它使用人工神经网络来模拟人脑的结构和功能。卷积神经网络（CNN）和循环神经网络（RNN）是两种常用的深度学习架构。',
      tags: ['深度学习', '神经网络'],
      createdAt: Date.now(),
      updatedAt: Date.now(),
    },
